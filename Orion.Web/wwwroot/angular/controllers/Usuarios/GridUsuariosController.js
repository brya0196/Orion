(function(){
    ...
    app.controller("GridUsuariosController", ["$scope", "StoreService", "UsuariosRepository", GridUsuariosController]);

    function GridUsuariosController($scope, StoreService, UsuariosRepository) {
